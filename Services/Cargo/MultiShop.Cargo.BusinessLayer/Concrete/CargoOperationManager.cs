...
namespace MultiShop.Cargo.BusinessLayer.Concrete
{
    public class CargoOperationManager : ICargoOperationService
    {
        ...
        public Task<List<CargoOperation>> TGetAllAsync()
        {
            return _cargoOperationDal.GetAllAsync();
        }

        public Task<CargoOperation> TGetByIdAsync(int id)
        {
            return _cargoOperationDal.GetByIdAsync(id);
        }
