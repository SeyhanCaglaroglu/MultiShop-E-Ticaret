...
{
    opt.LoginPath = "/Register/Index/";
    opt.LogoutPath = "/Register/Logout/";
    opt.AccessDeniedPath = "/Pages/AccessDenied/"; // erisim olmiyan sayfaya erismeye calisildiginda
    opt.Cookie.HttpOnly = true;  // https e gerek kalmadan
    opt.Cookie.SameSite = SameSiteMode.Strict; // cerezlere diger siteden erisimi engeller
    opt.Cookie.SecurePolicy = CookieSecurePolicy.SameAsRequest; // istek https ile yapildiysa cerez gvnli olrk isrt
...
//UserService tarafýndan yapýlan HTTP isteklerinde otomatik olarak yetkilendirme baþlýðýnýn (Authorization) eklenmesini saðlar ve token süresi dolduðunda yenileme iþlemini yapar.
...
//Order Adress
builder.Services.AddHttpClient<IAdressService, AdressService>(opt =>
{
...
//CargoCompany
builder.Services.AddHttpClient<ICargoCargoCompanyService, CargoCompanyService>(opt =>
{
...
//CategoryService sinifindan categoryleri yonetme
